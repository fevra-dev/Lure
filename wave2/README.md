...
| Wave | Plans | Status |
|---|---|---|
| Wave 1 | A (ProxyGuard detectors), B (OAuthGuard state abuse) | ✅ Complete |
| Wave 2 | C (DataEgressMonitor blob detector), D (Starkiller KQL) | ✅ Complete |
| Wave 3 | E (ExtensionAuditor DNR headers), F (Ownership drift + C2 polling), G (AgentIntentGuard) | ⏳ Pending |
